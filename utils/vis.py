...
def vis_nuscene():
    ...
    # file_gt = 'data/occ3d-nus/gts/scene-0061/0cd661df01aa40c3bb3a773ba86f753a' # change this to the gt folder path on your machine
    ...
    file_gt = 'data/occ3d-nus/gts/scene-0061/0cd661df01aa40c3bb3a773ba86f753a/labels.npz' # change this to the gt folder path on your machine
    data = np.load(file_gt)
    semantics, mask_lidar, mask_camera = data['semantics'], data['mask_lidar'], data['mask_camera']
